...
void solve() {
    ...
    if (a[0][0] >= a[2][0] && a[1][0] <= a[2][0] && a[0][1] == a[2][1] && a[1][1] == a[2][1]) {
		ans += 2;
	} else if (a[0][0] == a[2][0] && a[1][0] == a[2][0] && a[0][1] >= a[2][1] && a[1][1] <= a[2][1]) {
		ans += 2;
	} else if (a[0][0] == a[2][0] && a[1][0] == a[2][0] && a[1][1] >= a[2][1] && a[0][1] <= a[2][1]) {
		ans += 2;
	} else if (a[1][0] >= a[2][0] && a[0][0] <= a[2][0] && a[0][1] == a[2][1] && a[1][1] == a[2][1]) {
		ans += 2;
	}
