...
void solve() {
    ...
    ans = min(ans, getChar("AB", "C"));
    ans = min(ans, getChar("A", "BC"));
    ans = min(ans, getChar("AC", "B"));
    ans = min(ans, getChar("AB", "BC"));
    ans = min(ans, getChar("AC", "BC"));
    ans = min(ans, getChar("AC", "AB"));
    if (ans == INF) {
		ans = -1;
	}
	cout << ans << endl;
