...
int findStartPosition(int nums[], int size, int target) {
    int l = 0, r = size - 1;
    int start = -1;
    while (l <= r) {
        int mid = l + (r - l) / 2;
...
int findEndPosition(int nums[], int size, int target) {
    int l = 0, r = size - 1;
    int end = -1;
    while (l <= r) {
        int mid = l + (r - l) / 2;
...
void solve() {
	int arr[] = {2, 3, 3, 3, 3, 3, 4, 5, 10, 10, 10, 18, 20};
	int size = sizeof(arr) / sizeof(arr[0]);
	int target = 20;
	int first = findStartPosition(arr, size, target);
	int last = findEndPosition(arr, size, target);
